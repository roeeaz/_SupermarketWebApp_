...
function HomePage() {
  ...
  useEffect(() => {
    axios.get('http://127.0.0.1:8000/discounted_products/')
  ...
  return (
    ...
    <a href="#" onClick={(e) => { e.preventDefault(); setShowTerms(true); }}>
        <img className="img8" src="https://www.solidbackgrounds.com/images/1920x1080/1920x1080-amber-orange-solid-color-background.jpg" alt="Legend 2" />
    </a>
</div>
